...
galleryImgContainer.addEventListener("click", handleImageActivation);
galleryImgContainer.addEventListener("keydown", handleImageActivation);
...
const cartPopoverBody = document.getElementById("cart-popover-body");
const cartItemRemove = document.getElementById("cart-item-remove");
const cartPopoverFooter = document.getElementById("cart-popover-footer");
...
// Close the popover if clicking anywhere else on the page.
document.addEventListener("click", (e) => {
  if (!cartTrigger.contains(e.target) && !cartPopover.contains(e.target)) {
...
function updateCartUI() {
  const isEmpty = totalItemsInCart === 0;

  cartPopoverBody.style.display = isEmpty ? "none" : "block";
  cartPopoverFooter.style.display = isEmpty ? "none" : "block";
  cartEmptyMsg.style.display = isEmpty ? "block" : "none";

  // Update pin qty
  if (cartBadge) cartBadge.textContent = totalItemsInCart;
}

/* ==================================================================
  Add to cart quantity
================================================================== */
const addBtn = document.querySelector(".product__btn-add");
